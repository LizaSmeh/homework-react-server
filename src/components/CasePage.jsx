...
export const CasePage = () => {
	const { setUpdateCaset, cases, setCases } = useContext(AppContext);
	const { id } = useParams();
	...
	return (
		<>
			<ul className={styles.list}>
				<li className={styles.case} key={cases.id}>
					{cases.content}

					<button
						className={styles.icon}
						onClick={() => requestDeleteCase(cases.id)}
					>
						<svg
					...
					<button
						onClick={() =>
							requestUpdateCase(cases.content, cases.id)
						}
					>
						<svg
							xmlns="http://www.w3.org/2000/svg"
						...
						>
							...
							<path
								fill="#f0f0f0"
								d="M6.905,35.43L5,43l7.571-1.906l0.794-6.567L6.905,35.43z"
							></path>
							<path
								fill="#edbe00"
							...
							></path>
							<linearGradient
								id="YoPixpDbHWOyk~b005eF1a_OWRPl8fxkRvG_gr1"
								x1="35.612"
								x2="35.612"
								y1="7.494"
								y2="17.921"
							...
							<path
								fill="url(#YoPixpDbHWOyk~b005eF1a_OWRPl8fxkRvG_gr1)"
								d="M30.363,11.968l4.832-4.834l5.668,5.664l-4.832,4.834L30.363,11.968z"
							></path>
							<path
								fill="#787878"
								d="M5.965,39.172L5,43l3.827-0.965L5.965,39.172z"
							></path>
						</svg>
					</button>
					<button
						...
						style={{ height: "90px" }}
					>
						<span style={{ color: "rgb(215, 176, 190)" }}>
							Назад
						</span>
					</button>
				</li>
