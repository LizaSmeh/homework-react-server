...
function App() {
	...
	const { resultSearch } = useSearch(cases, search);
	...
	const handleAdd = (e) => {
		e.preventDefault();
		if (newCase.trim()) {
			dispatch(requestAddCase(newCase));
			setNewCase("");
		}
	};
 const sortOne = () => {
